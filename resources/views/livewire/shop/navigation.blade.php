<div x-data="{
        ...
        <div class="flex">
            ...
            <div class="w-80 xl:w-[57rem] pt-[52px] hidden md:block">
                <div class="h-[calc(100vh-52px)] overflow-auto bg-gray-100 dark:bg-gray-900 px-6 py-8">
                    <div class="mb-8 flex justify-between items-center border-b-[3px] border-[#E39F00] uppercase text-xl font-bold text-gray-700 dark:text-white">
    @if ($family_id)
    ...
    @else
        <span class="text-gray-500">No hay familia seleccionada.</span>
    @endif
</div>
